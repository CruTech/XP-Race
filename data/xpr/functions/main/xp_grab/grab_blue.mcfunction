...
execute if score @s cycle matches 2 if score @s xp_current matches 1.. run scoreboard players operation Blue xp_score += @s xp_current
# Check if team has new top score
execute if score @s cycle matches 2 run scoreboard players operation ♦Admin♦ top_score > Blue xp_score
